...
#http://worldleague.2015.fivb.com/en/api/volley/matches/WL2015-1/en/comments/5869
...
schedule["Matches"].each do |match|
  ...
  if (match_date <= Date.today)
    url = "#{base}/#{tournament_id}/en/comments/#{id}"

    file_name = "#{tournament_code}/comments_#{id}.json"
